			    ...
			    const char *buff, size_t size)
{
	...
	/* <DTS2017041000137 danghao/wx427581 20170414 begin */
	//sscanf(buff, "%d", &enabled);
	if(1 != sscanf(buff, "%d", &enabled)){
		pr_notice("set enable use invalid number");
		enabled = dev->enabled ? 1 : 0;
	}
	/* DTS2017041000137 danghao/wx427581 20170414 end> */
