...
/* < DTS2016040708137 lijinjun/lwx343079 begin */
...
#endif
/* < DTS2016070704209 jiangtao/jwx348002 20160829 begin */
#ifdef CONFIG_COMPACTION
#include <linux/compaction.h>
#endif
/* < DTS2016070704209 jiangtao/jwx348002 20160829 end */
...
/*<DTS2015110304872  machao/mwx306152 20151127 begin */
#ifdef CONFIG_LOG_JANK
static ulong lowmem_kill_count = 0;
static ulong lowmem_free_mem = 0;
#endif
/*<DTS2015110304872  machao/mwx306152 20151127 end */
	...
	for_each_online_pgdat(pgdat) {
		for (zoneidx = 0; zoneidx <= high_zoneidx; zoneidx++) {
			...
			if (fragmentation_index(z, THREAD_SIZE_ORDER) > sysctl_extfrag_threshold)
                        {
                                /* < DTS2016092905645 jiangtao/jwx348002 20160929 begin */
                                if(adj < 2) 
                                   return adj;
                                else
				   return 2;
                                /* < DTS2016092905645 jiangtao/jwx348002 20160929 end */
                        }
		}
	}
#endif
...
/*<DTS2016072204893   yangfei/ywx353749 20160812 begin */
#if 0
#ifdef CONFIG_LOG_JANK
		spin_unlock(&lowmem_shrink_lock);
#endif
...
#ifdef CONFIG_LOG_JANK
		spin_trylock(&lowmem_shrink_lock);
#endif
#endif
/*<DTS2016072204893   yangfei/ywx353749 20160812 end */
