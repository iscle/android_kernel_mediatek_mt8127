...
#endif
/*DTS2016072809504 zhangchao69 zwx373423 20160728 begin*/
#if 0
#define MTK_BINDER_DEBUG        "v0.1"	/* defined for mtk internal added debug code */
#endif
/*DTS2016072809504 zhangchao69 zwx373423 20160728 end*/
	...
	while (ptr < end && thread->return_error == BR_OK) {
		...
		case BC_FREE_BUFFER: {
			...
			if (buffer->async_transaction && buffer->target_node) {
				...
				/*DTS2016080105888 zhangchao69 zwx373423 20160801 begin*/
					list_move_tail(buffer->target_node->async_todo.next, &proc->todo);
				/*DTS2016080105888 zhangchao69 zwx373423 20160801 end*/
