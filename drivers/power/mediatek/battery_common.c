...
#endif
/*<DTS2017020401531 rentianzhi 20170302 begin*/
#include "../../misc/mediatek/power/mt8127/fan5405.h"
extern int g_charger_weaked;
#define VBUS_DET_THOD_3300MV 3300
/*DTS2017020401531 rentianzhi 20170302 end>*/
/*<DTS2017030904519 rentianzhi 20170323 begin*/
extern signed int g_rtc_fg_soc;
#define ALLOW_DIFF_BETWEEN_RTC_AND_REAL 15
/*DTS2017030904519 rentianzhi 20170323 end>*/
/* ////////////////////////////////////////////////////////////////////////////// */
...
static char *battery_id[] = {"Unknown", "SCUD", "SUNWODA", "DESAY"};
#endif
/*DTS2016122104616 liuguangchao/lwx422269  20161229 end >*/
/*DTS2016120605050 guoyuanyuan/gwx422270 20161206 begin */
#ifdef CONFIG_HUAWEI_DSM
#include 	<dsm/dsm_pub.h>
#include <asm-generic/gpio.h>
#include <linux/delay.h>
#define CLIENT_NAME_POWER_SM5414		"dsm_charger"
/*<  DTS2017011811081  yanzhiyao 20170119 begin*/
/*<  DTS2017011811081  yanzhiyao 20170317 begin*/
#define CHARGER_TYPE_REDETECT_DELAY	100
#define NONSTANDARD_CHARGER_REDETECTE_TIMES 2
/*  DTS2017011811081  yanzhiyao 20170317 end >*/
/*  DTS2017011811081  yanzhiyao 20170119 end >*/
/*<  DTS2017031002702  yanzhiyao 20170313 begin*/
#define CUST_SOC_DELAY_TIME	60
#define SOC_FULL	100
#define CUST_SOC_FULL	98
static int cust_soc_delay_counter = 0;
/*  DTS2017031002702  yanzhiyao 20170313 end >*/
/*< DTS2017040201460 zhixueyin WX430340 20170413 begin*/
#define SOC_SYNC_PERIOD		8 /* AC charging 1% capacity of period */
#define SYNC_THRESHOLD		2  /* UI_SOC Sync to SOC threshold */
/* DTS2017040201460 zhixueyin WX430340 20170413 end>*/
/*<DTS2017032800426 rentianzhi WX430340 20170329 begin*/
#define BAT_VCHR_CHANL_NUM 4
#define BAT_TIMES 5
#define BAT_R_CHR_1 330
#define BAT_R_CHR_2 39
#define BAT_PERMETER 100
/*DTS2017032800426 rentianzhi WX430340 20170329 end>*/
...
int sm5414_dsm_report_err(int errno)
{
	int size = 0;
	...
	"vbus1:%d,vbat1:%d,capacity:%d,present:%d,,temp:%d\n"
...
#endif
/*DTS2016120605050 guoyuanyuan/gwx422270 20161206 end */
...
/*< DTS2017032006351 rentianzhi WX430340 20170327 begin */
#define RECHARGE_THRES 14 /*the threshold to decrease ui_soc*/
#define HW_5_PER 5
/* DTS2017032006351 rentianzhi WX430340 20170327 end> */
...
/* DTS2017022306151  rentianzhi WX430340 20170313 begin >*/
static DEFINE_MUTEX(chrdet_int_mutex);
/* DTS2017022306151 rentianzhi WX430340 20170313 end> */
...
/*< DTS2017032006351 rentianzhi WX430340 20170327 begin */
static bool is_uisoc_ever_100 = KAL_FALSE;
static int hw_start_to_100_count = 0;
/* DTS2017032006351 rentianzhi WX430340 20170327 end> */
...
struct battery_data {
	...
	/*<DTS2016122706296 yanzhiyao 20161226 begin*/
	signed int BAT_Current_now;
	/*DTS2016122706296 yanzhiyao 20161226 end >*/
...
static enum power_supply_property battery_props[] = {
	...
	/* DTS2016122706296 yanzhiyao 20161226 end >*/
	/*< DTS2017011203843 yanzhiyao 20170113 begin*/
	POWER_SUPPLY_PROP_Enable_charger,
	/* DTS2017011203843 yanzhiyao 20170113 end >*/
	...
	/*DTS2016122902048 rentianzhi WX430340  20170117 begin >*/
	POWER_SUPPLY_PROP_CHARGE_FULL_DESIGN,
	/*DTS2016122902048 rentianzhi WX430340  20170117 end >*/
};
...
/*DTS2016122104616 liuguangchao/lwx422269  20161229 begin >*/
#ifdef CONFIG_MTK_MULTI_BAT_PROFILE_SUPPORT
void hardware_info_battery_id(void)
{
	char *temp = battery_id[battery_type_id];
	register_hardware_info(BATTERY_TYPE, temp);
}
#endif
/*DTS2016122104616 liuguangchao/lwx422269  20161229 end >*/
				...
				enum power_supply_property psp, union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_Enable_charger:
		val->intval = BMT_status.Charger_enable;
		break;
	/* DTS2017011203843 yanzhiyao 20170113 end >*/
	...
	case POWER_SUPPLY_PROP_CHARGE_FULL_DESIGN:
		val->intval = batt_cust_data.charge_full_design;
		break;
	/*DTS2016122902048 rentianzhi WX430340  20170117 end >*/
...
{
	int ret = 0;
	battery_log(BAT_LOG_CRTI,  "prop: %d\n", psp);
	switch (psp) {
	case POWER_SUPPLY_PROP_Enable_charger:
		ret = battery_charging_control(CHARGING_CMD_ENABLE,(void*)&(val->intval));
		BMT_status.Charger_enable = val-> intval;
		if(BMT_status.Charger_enable == 0)
			cmd_discharging = 1;
		else
			cmd_discharging = 0;
		break;
...
static ssize_t show_ADC_Charger_Voltage(struct device *dev, struct device_attribute *attr,
					char *buf)
{
	/*< DTS2017031309250 rentianzhi WX430340 20170314 begin */
	BMT_status.charger_vol = battery_meter_get_charger_voltage();
	/* DTS2017030400825 rentianzhi WX430340 20170314 end> */
...
static void mt_battery_update_EM(struct battery_data *bat_data)
{
	...
	/*< DTS2016122706296 yanzhiyao 20161226 begin*/
	bat_data->BAT_Current_now = BMT_status.Current_now;
	/* DTS2016122706296 yanzhiyao 20161226 end >*/
...
static kal_bool mt_battery_100Percent_tracking_check(void)
{
	...
	if (BMT_status.bat_full == KAL_TRUE) {	/* charging full first, UI tracking to 100% */
		...
		battery_log(BAT_LOG_CRTI, "[100percent], hw_start_to_100_count(%d) to 0\n",
			    hw_start_to_100_count);
		hw_start_to_100_count = 0;
		/* DTS2017032006351 rentianzhi WX430340 20170327 end> */
	} else {
             /*<  DTS2017031002702  yanzhiyao 20170313 begin*/
		/*< DTS2017032006351 rentianzhi WX430340 20170327 begin */
		if((BMT_status.UI_SOC >= CUST_SOC_FULL) && (BMT_status.UI_SOC < SOC_FULL)
			&& (BMT_status.charger_exist) && ((BMT_status.UI_SOC - BMT_status.SOC) < HW_5_PER)) {
			hw_start_to_100_count++;
			if(cust_soc_delay_counter > CUST_SOC_DELAY_TIME / BAT_TASK_PERIOD ) {
				BMT_status.UI_SOC++;
				cust_soc_delay_counter = 0;
			}
			else
				cust_soc_delay_counter++;
		battery_log(BAT_LOG_CRTI, "[100percent], 98 to 100 now UI_SOC(%d), cust_soc_delay_counter(%d),hw_start_to_100_count(%d) \n",
			    BMT_status.UI_SOC, cust_soc_delay_counter, hw_start_to_100_count);
		}
		else {
			cust_soc_delay_counter =0;
		}
		/*< DTS2017032006351 rentianzhi WX430340 20170329 begin */
		if ((BMT_status.SOC == SOC_FULL) || ((BMT_status.UI_SOC - BMT_status.SOC) > RECHARGE_THRES)) {
			hw_start_to_100_count = 0;
			is_uisoc_ever_100 = KAL_FALSE;
			battery_log(BAT_LOG_CRTI, "[100percent], UI_SOC(%d), SOC(%d), ever100(%d), hw_start_to_100_count(%d) to 0\n",
			    BMT_status.UI_SOC, BMT_status.SOC, is_uisoc_ever_100, hw_start_to_100_count);
		}
		/* DTS2017032006351 rentianzhi WX430340 20170329 end> */
		/* DTS2017032006351 rentianzhi WX430340 20170327 end> */
             /*  DTS2017031002702  yanzhiyao 20170313 end >*/
...
{
	static unsigned int timer_counter;
	static unsigned int keep_ui_counter = 0;
	/*<  DTS2017040201460  zhixueyin 20170412 begin*/
	static unsigned int ascend_count = 0;
	/*  DTS2017040201460  zhixueyin 20170412 end >*/

	if ((BMT_status.UI_SOC > BMT_status.SOC) && ((BMT_status.UI_SOC != 1))) {
#if !defined(SYNC_UI_SOC_IMM)
		/* reduce after xxs */
		/*< DTS2017020904580 zhixueyin WX422270 20170213 begin */
		/*< DTS2017032006351 rentianzhi WX430340 20170327 begin */
		if (chr_wake_up_bat == KAL_FALSE) {
			if ((BMT_status.charger_exist == KAL_TRUE) && (hw_start_to_100_count > 0) && (BMT_status.SOC < SOC_FULL)) {
				battery_log(BAT_LOG_CRTI, "[Sync_Real] start 98 to 100, UI_SOC = %d, SOC = %d, hw_start_to_100_count = %d\n",
					BMT_status.UI_SOC, BMT_status.SOC, hw_start_to_100_count);
			} else {
				if (timer_counter ==
				    (batt_cust_data.sync_to_real_tracking_time / BAT_TASK_PERIOD)) {
				      /*< DTS2017020707324 zhixueyin WX422270 20170301 begin */
					(BMT_status.UI_SOC == 100 && BMT_status.charger_exist == KAL_FALSE) ? keep_ui_counter++ : (keep_ui_counter = 0);
					if ((KEEP_UI_SOC_TIME == keep_ui_counter) ||
						(0 == keep_ui_counter)){
						BMT_status.UI_SOC--;
						keep_ui_counter = 0;
					}
					timer_counter = 0;
				       /* DTS2017020707324 zhixueyin WX422270 20170301 end >*/
				}
#ifdef FG_BAT_INT
		...
		/* DTS2017032006351 rentianzhi WX430340 20170327 end> */
			/* DTS2017020904580 zhixueyin WX422270 20170213 end >*/
		} else {
			battery_log(BAT_LOG_CRTI,
		...
		if (BMT_status.UI_SOC == -1){
			if(abs(g_rtc_fg_soc - BMT_status.SOC) < ALLOW_DIFF_BETWEEN_RTC_AND_REAL && g_rtc_fg_soc!=0)
				BMT_status.UI_SOC = g_rtc_fg_soc;
			else
				BMT_status.UI_SOC = BMT_status.SOC;
		}
		/*DTS2017030904519 rentianzhi 20170323 end>*/
			...
			if (BMT_status.UI_SOC < BMT_status.SOC
			    ...
			    /*<  DTS2017031002702  yanzhiyao 20170313 begin*/
			    &&(BMT_status.UI_SOC < SOC_FULL))
			    /*  DTS2017031002702  yanzhiyao 20170313 end >*/
				{
					/*<  DTS2017040201460  zhixueyin 20170412 begin*/
					if ((BMT_status.SOC - BMT_status.UI_SOC >= SYNC_THRESHOLD)
						&& (BMT_status.UI_SOC < CUST_SOC_FULL))
					{
						ascend_count++;
						if (ascend_count >= SOC_SYNC_PERIOD)
						{
							BMT_status.UI_SOC++;
							ascend_count = 0;
						}
						battery_log(BAT_LOG_CRTI, "[Sync_Real]UI_SOC = %d, UI_SOC is less than SOC %d, ascend_count = %d\r\n",
								BMT_status.UI_SOC, BMT_status.SOC - BMT_status.UI_SOC, ascend_count);
					}
					else
					{
						BMT_status.UI_SOC++;
...
static void battery_update(struct battery_data *bat_data)
{
	...
	if ((BMT_status.charger_exist == KAL_TRUE) && (BMT_status.bat_charging_state != CHR_ERROR)) {
		...
		/* DTS2017010602845  rentianzhi/WX430340 20170110 begin */
		bat_data->BAT_STATUS = POWER_SUPPLY_STATUS_DISCHARGING;
		/* DTS2017010602845  rentianzhi/WX430340 20170110 end */
		if (BMT_status.bat_vol <= batt_cust_data.v_0percent_tracking)
			resetBatteryMeter = mt_battery_0Percent_tracking_check();
		else
...
/*< DTS2017020402081 zhixueyin WX422270 20170213 begin */
#if defined(CUST_CAPACITY_OCV2CV_TRANSFORM)
/* DTS2017020402081 zhixueyin WX422270 20170213 end >*/
...
static void usb_update(struct usb_data *usb_data)
{
	...
	/*DTS2017011711146 rentianzhi WX430340  20170123 begin >*/
	if (BMT_status.charger_exist == KAL_TRUE) {
	...
	/*DTS2017011711146 rentianzhi WX430340  20170123 end >*/
...
/*< DTS2017032304801 rentianzhi WX430340 20170327 begin */
static void mt_battery_charger_detect_check(int hw_is_weaked)
{
/* DTS2017032304801 rentianzhi WX430340 20170327 end> */
/*<  DTS2017011811081  yanzhiyao 20170119 begin*/
#if !defined(CONFIG_MTK_WIRELESS_CHARGER_SUPPORT)
	int retry_times = NONSTANDARD_CHARGER_REDETECTE_TIMES;
#endif
/*  DTS2017011811081  yanzhiyao 20170119 end >*/
...
#endif
	/*< DTS2017032304801 rentianzhi WX430340 20170327 begin */
	if (upmu_is_chr_det() == KAL_TRUE || hw_is_weaked) {
	/* DTS2017032304801 rentianzhi WX430340 20170327 end> */
		...
		if ((BMT_status.charger_type == CHARGER_UNKNOWN) &&
			...
			while ((BMT_status.charger_type == NONSTANDARD_CHARGER) &&
				retry_times-- > 0){
				msleep(CHARGER_TYPE_REDETECT_DELAY);
				mt_charger_type_detection();
				battery_log(BAT_LOG_CRTI, "nonstandard charger , redetecting...\n");
			}
			/*  DTS2017011811081  yanzhiyao 20170119 end >*/
...
{
	/*<DTS2017032800426 rentianzhi WX430340 20170329 begin*/
	signed int do_VChr = 0;
	/*DTS2017032800426 rentianzhi WX430340 20170329 end>*/

	/* DTS2017022306151  rentianzhi WX430340 20170313 begin >*/
	mutex_lock(&chrdet_int_mutex);
	/* DTS2017022306151 rentianzhi WX430340 20170313 end> */
	if (g_bat_init_flag == KAL_TRUE) {
		...
		if ((DISO_data.diso_state.cur_vusb_state == DISO_ONLINE) ||
			...
			/*< DTS2017030400825 rentianzhi WX430340 20170314 begin */
			/*<DTS2017020401531 rentianzhi 20170302 begin*/
			/*<DTS2017032313481 rentianzhi 20170323 begin*/
			/*<DTS2017032800426 rentianzhi WX430340 20170329 begin*/
			do_VChr = PMIC_IMM_GetOneChannelValue(BAT_VCHR_CHANL_NUM, BAT_TIMES, 1);
			do_VChr = (((BAT_R_CHR_1+BAT_R_CHR_2)*BAT_PERMETER*do_VChr)/BAT_R_CHR_2) / BAT_PERMETER;
			/*DTS2017032800426 rentianzhi WX430340 20170329 end>*/
			if ((do_VChr< VBUS_DET_THOD_3300MV) || (!mt_usb_is_device())) {
			/*DTS2017032313481 rentianzhi 20170323 end>*/
				pr_info("%s:usb plug out and vbus below 2000mV \n",__func__);
				g_charger_weaked = 0;
				battery_log(BAT_LOG_CRTI, "[do_chrdet_int_task] charger NOT exist!\n");
				BMT_status.charger_exist = KAL_FALSE;
			} else {
				pr_info("%s:charger is weak \n",__func__);
				fan5405_set_iocharge(0x0);
				g_charger_weaked = 1;
				BMT_status.charger_exist = KAL_TRUE;
				wake_lock(&battery_suspend_lock);
			}
		...
		/*< DTS2017032304801 rentianzhi WX430340 20170327 begin */
		mt_battery_charger_detect_check(g_charger_weaked);
		/* DTS2017032304801 rentianzhi WX430340 20170327 end> */
		if (BMT_status.UI_SOC == 100 && BMT_status.charger_exist == KAL_TRUE) {
			BMT_status.bat_charging_state = CHR_BATFULL;
			BMT_status.bat_full = KAL_TRUE;
...
void BAT_thread(void)
{
	...
	/*< DTS2017032304801 rentianzhi WX430340 20170327 begin */
	mt_battery_charger_detect_check(0);
	/* DTS2017032304801 rentianzhi WX430340 20170327 end> */
...
/*DTS2016120605050 guoyuanyuan/gwx422270 20161206 begin */
	...
	while (1) {
		...
		/* <DTS2017020803546 rentianzhi WX430340 20170217 begin */
		if (((chargin_hw_init_done == KAL_TRUE) && (battery_suspended == KAL_FALSE))
			...
			BAT_thread();
		/* DTS2017020803546 rentianzhi WX430340 20170217 end> */
...
/*DTS2016120605050 guoyuanyuan/gwx422270 20161206 begin */
		...
		sm5414_dsm_report_err(DSM_BATTERY_VOLTAGE_OVER_NO);
		if((battery_vbat_dsm<2500)&&(battery_vbat_dsm>0))
		sm5414_dsm_report_err(DSM_BATTERY_VOLTAGE_BELOW_NO);
		temp_capacity=battery_capacity_dsm;
		if(i==5)
		{
		do_gettimeofday(&tv_first);
		//printk("1111111111=%ld,%ld\n",tv_first.tv_sec,tv_first.tv_usec);
		...
		//printk("1111111112=%ld,%ld\n",tv_last.tv_sec,tv_last.tv_usec);
		temp_capacity=battery_capacity_dsm;
		i=5;
		}

		   if(((temp_capacity-first_capacity)>5 || (temp_capacity-first_capacity<-5))&&(first_capacity!=0)&&((tv_last.tv_sec-tv_first.tv_sec)>60)&&((tv_last.tv_sec-tv_first.tv_sec)<120))
		   	{
		   	SM5414_ERR("dsm capcity error first capacity:%d,last capacity:%d,first.tv_sec:%ld,last.tv_sec:%ld \n", first_capacity,temp_capacity,tv_first.tv_sec,tv_last.tv_sec);
...
static irqreturn_t diso_auxadc_irq_thread(int irq, void *dev_id)
{
	...
	case DC_ONLY:
		BMT_status.charger_type = CHARGER_UNKNOWN;
		/*< DTS2017032304801 rentianzhi WX430340 20170327 begin */
		mt_battery_charger_detect_check(0);	/* plug in VUSB, check if need connect usb */
		/* DTS2017032304801 rentianzhi WX430340 20170327 end> */
		break;
	default:
		battery_log(BAT_LOG_CRTI,
...
static int __batt_init_cust_data_from_dt(void)
{
	...
	/*DTS2016122212875 liuguangchao/lwx422269  20161222 begin >*/
	__batt_parse_node(np, "jeita_temp_pos_0_to_pos_10_full_current",
		&batt_cust_data.jeita_temp_pos_0_to_pos_10_full_current);

	__batt_parse_node(np, "jeita_temp_pos_45_to_pos_60_full_current",
		&batt_cust_data.jeita_temp_pos_45_to_pos_60_full_current);

	__batt_parse_node(np, "jeita_temp_pos_0_to_pos_5_full_current",
		&batt_cust_data.jeita_temp_pos_0_to_pos_5_full_current);

	__batt_parse_node(np, "jeita_temp_pos_5_to_pos_10_full_current",
		&batt_cust_data.jeita_temp_pos_5_to_pos_10_full_current);
	/*DTS2016122212875 liuguangchao/lwx422269  20161222 end >*/
	...
	/*DTS2016122902048 rentianzhi WX430340  20170117 begin >*/
	__batt_parse_node(np, "charger-batt-capacity-mah",
		&batt_cust_data.charge_full_design);
	/*DTS2016122902048 rentianzhi WX430340  20170117 end >*/
...
static ssize_t current_cmd_write(struct file *file, const char *buffer, size_t count, loff_t *data)
{
	...
	if (sscanf(desc, "%d %d", &cmd_current_unlimited, &cmd_discharging) == 2) {
		/*DTS2017010409445 rentianzhi/WX430340 20170105 begin */
		//set_usb_current_unlimited(cmd_current_unlimited);
		/*DTS2017010409445 rentianzhi/WX430340 20170105 end */
		if (cmd_discharging == 1) {
