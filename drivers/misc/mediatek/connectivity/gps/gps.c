...
static ssize_t mt3326_gps_write(struct file *file, const char __user *buf, size_t count, loff_t *ppos)
{
	...
	if (down_interruptible(&dev->sem))
        ...
        /*< DTS2017021704147  chensuyu/mwx427577 20170221 begin */
	count = (count < sizeof(dev->dat_buf)) ? count : sizeof(dev->dat_buf);
	/* DTS2017021704147  chensuyu/mwx427577 20170221 end >*/
