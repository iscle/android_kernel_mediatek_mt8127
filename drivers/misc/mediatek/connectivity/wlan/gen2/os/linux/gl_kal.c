...
/* < DTS2017040605631 wwx427566 20170408 begin */
...
/* DTS2017040605631 wwx427566 20170408 end > */
/*******************************************************************************
*                                 M A C R O S
********************************************************************************
*/
...
/*< DTS2016120105146 mengpan/mwx247577 20161201 begin */
#ifdef CONFIG_HUAWEI_DSM
		wifi_dsm_report_err(DSM_WIFI_DRIVER_LOAD_ERR,"load fw error",0);
#endif
/* DTS2016120105146 mengpan/mwx247577 20161201 end >*/
		goto error_open;
	}
...
kalIndicateStatusAndComplete(IN P_GLUE_INFO_T prGlueInfo, IN WLAN_STATUS eStatus, IN PVOID pvBuf, IN UINT_32 u4BufLen)
{
	...
	struct cfg80211_bss *con_bss;
	/* DTS2017030106274  wangxuan/wwx427566 20170215 end> */
	UINT_8 ucChannelNum;
	P_BSS_DESC_T prBssDesc = NULL;
	/* <DTS2017020305010 wangxuan/wwx427566 20170215 begin */
	OS_SYSTIME rCurrentTime;
	BOOLEAN fgIsNeedUpdateBss = FALSE;
	/* DTS2017020305010 wangxuan/wwx427566 20170215 end> */
	...
	case WLAN_STATUS_MEDIA_CONNECT:
		...
		if (prGlueInfo->fgIsRegistered == TRUE) {
			...
			if (bss == NULL) {
				/* < DTS2017030106274  wangxuan/wwx427566 20170215 begin */
				DBGLOG(AIS, INFO, "MTKDEBUG BSS is NUll\n");
				/* DTS2017030106274  wangxuan/wwx427566 20170215 end> */
				...
				/* < DTS2017030106274  wangxuan/wwx427566 20170215 begin */
				if (prBssDesc == NULL) {
					DBGLOG(AIS, INFO, "MTKDEBUG Target BSS is NUll\n");
				}
				/* DTS2017030106274  wangxuan/wwx427566 20170215 end> */
				/* <DTS2017020305010 wangxuan/wwx427566 20170215 begin */
				if (prBssDesc != NULL) {
				    /* cfg80211 bss expire time is 7s. if bss in driver older then 5s, update to cfg80211 again. */
				...
				if (prBssDesc != NULL) {
					...
					/* < DTS2017030106274  wangxuan/wwx427566 20170215 begin */
					if (bss == NULL) {
						DBGLOG(AIS, INFO, "MTKDEBUG After inform BSS is NUll\n");
					}
					/* DTS2017030106274  wangxuan/wwx427566 20170215 end> */
				}
			/* < DTS2017030106274  wangxuan/wwx427566 20170215 begin */
			} else {
				DBGLOG(AIS, INFO, "MTKDEBUG BSS is not NUll\n");
			}
			/* DTS2017030106274  wangxuan/wwx427566 20170215 end> */

			con_bss = cfg80211_get_bss(priv_to_wiphy(prGlueInfo), prChannel, arBssid,
					       ssid.aucSsid, ssid.u4SsidLen, WLAN_CAPABILITY_ESS, WLAN_CAPABILITY_ESS);
			/* < DTS2017030106274  wangxuan/wwx427566 20170215 begin */
			if (con_bss ==  NULL) {
					DBGLOG(AIS, ERROR, "MTKDEBUG Indicated BSS is NUll\n");
			}
			DBGLOG(AIS, INFO, "MTKDEBUG Final SSID %s Len %d BSSID %pM\n", ssid.aucSsid, ssid.u4SsidLen, arBssid);
			/* DTS2017030106274  wangxuan/wwx427566 20170215 end> */
			/* CFG80211 Indication */
