			     ...
			     u64 *cookie)
{
	...
	do {
		...
		/*DTS2016081202651 zhangchao69 zwx373423 begin*/
		if (g_IsNeedDoChipReset){
			DBGLOG(P2P, INFO, "skip %s() during whole chip result\n", __func__);
			break;
		}
		/*DTS2016081202651 zhangchao69 zwx373423 end*/
		prGlueInfo = *((P_GLUE_INFO_T *) wiphy_priv(wiphy));
		prGlueP2pInfo = prGlueInfo->prP2PInfo;
