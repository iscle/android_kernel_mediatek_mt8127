...
VOID rsnGenerateWPAIE(IN P_ADAPTER_T prAdapter, IN P_MSDU_INFO_T prMsduInfo)
{
	...
	if ((1 /* prCurrentBss->fgIEWPA */ &&
		...
		(prAdapter->rWifiVar.rConnSettings.eAuthMode == AUTH_MODE_WPA_PSK)))) {
#endif
             /* < DTS2017022703833 yudehai/ywx427576 20170302 begin*/
		if ((prP2pSpecificBssInfo != NULL) && (prP2pSpecificBssInfo->u2WpaIeLen != 0)) {
			...
			return;
             ...
             /* DTS2017022703833 yudehai/ywx427576 20170302 end>*/
