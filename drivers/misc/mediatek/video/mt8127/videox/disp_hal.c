...
#include "dsi_drv.h"
#include "dsi_reg.h"
/* DTS2016122500640 ywx422261 20161227 begin */
#ifdef CONFIG_GET_HARDWARE_INFO
#include <asm/hardware_info.h>
#define DISP_PANEL_NAME_MAX_LEN 80
#endif
/* DTS2016122500640 ywx422261 20161227 begin */
...
LCM_DRIVER *disphal_get_lcm_driver(const char *lcm_name, unsigned int *lcm_index)
{
	...
	/* DTS2016122500640 ywx422261 20161227 begin */
	#ifdef CONFIG_GET_HARDWARE_INFO
	char lcd_hardware[DISP_PANEL_NAME_MAX_LEN] = {0};
	#endif
	/* DTS2016122500640 ywx422261 20161227 end */
	...
	/* DTS2016122500640 ywx422261 20161227 begin */
	#ifdef CONFIG_GET_HARDWARE_INFO
	if((NULL != lcm)&&(NULL != lcm->name)) {
		strncpy(lcd_hardware,lcm->name,DISP_PANEL_NAME_MAX_LEN);
		register_hardware_info(LCM,lcd_hardware);
	}
	#endif
	/* DTS2016122500640 ywx422261 20161227 end */
	if (isLCMFound) {
		...
		if((NULL != lcm)&&(NULL != lcm->gpio_init)){
			lcm->gpio_init();
		}
