...
#define PK_DBG_FUNC(fmt, arg...)    pr_debug(ANDROID_LOG_DEBUG  , TAG_NAME, "%s: " fmt, __func__ , ##arg)
#define PK_WARN(fmt, arg...)        pr_debug(ANDROID_LOG_WARNING, TAG_NAME, "%s: " fmt, __func__ , ##arg)
#define PK_NOTICE(fmt, arg...)      pr_debug(ANDROID_LOG_DEBUG  , TAG_NAME, "%s: " fmt, __func__ , ##arg)
#define PK_INFO(fmt, arg...)        pr_debug(ANDROID_LOG_INFO   , TAG_NAME, "%s: " fmt, __func__ , ##arg)
...
#define PK_ERROR(fmt, arg...)       pr_debug(ANDROID_LOG_ERROR  , TAG_NAME, "%s: " fmt, __func__ , ##arg)
