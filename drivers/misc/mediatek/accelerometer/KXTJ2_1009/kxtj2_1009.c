...
/*----------------------------------------------------------------------------*/
#ifdef CONFIG_GET_HARDWARE_INFO
#define MC3XXX_HARDWARE_INFO "Kionix,kxtj2_1009"
#endif
...
struct acc_hw accel_kj;
static struct acc_hw *hw = &accel_kj;
...
struct kxtj2_1009_i2c_data {
	...
	/* data , '+1' for 4-byte alignment */
	s8                      offset[KXTJ2_1009_AXES_NUM + 1];
...
#ifdef CONFIG_OF
/*<CPM2017011100217 shenxinyu 20170112 begin*/
static const struct of_device_id accel_of_match[] = {
	{.compatible = "mediatek,gsensor_kxtj"},
	{},
};
/*CPM2017011100217 shenxinyu 20170112 end>*/
#endif
...
static int KXTJ2_1009_SetDataResolution(struct kxtj2_1009_i2c_data *obj)
{
	...
	/*
	 * kxtj2_1009_data_resolution[0] has been set when initialize:
	 * +/-2g  in 8-bit resolution:  15.6 mg/LSB/ 
	 */
...
/*<CPM2017011100217 shenxinyu 20170111 begin*/
#ifdef CONFIG_GET_HARDWARE_INFO
	register_hardware_info(G_SENSOR,MC3XXX_HARDWARE_INFO);
#endif
/*CPM2017011100217 shenxinyu 20170111 end>*/
	GSE_LOG("%s: OK\n", __func__);
