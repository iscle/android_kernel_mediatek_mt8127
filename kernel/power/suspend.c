...
int suspend_devices_and_enter(suspend_state_t state)
{
	...
	if (!sleep_state_supported(state))
		return -ENOSYS;
	/* < DTS2016070704209 jiangtao/jwx348002 20160818 begin */
        drop_pagecache();
	/* < DTS2016070704209 jiangtao/jwx348002 20160818 end */
...
int suspend_syssync_enqueue(void)
{
	...
	if (suspend_sys_sync_work_queue == NULL) {
        ...
        /* < DTS2016070704209 jiangtao/jwx348002 20160721 begin */
	...
	if (!sys_sync_ongoing) {
        ...
        /* < DTS2016070704209 jiangtao/jwx348002 20160721 end */
	return -EBUSY;
}
